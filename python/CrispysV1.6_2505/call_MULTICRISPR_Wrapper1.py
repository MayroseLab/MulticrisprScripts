...
def CRISPys_main(fasta_file, path , alg = 'A', where_in_gene = 1, use_thr = 0,  Omega = 1, df_targets = Metric.cfd_funct, protodist_outfile = "outfile", min_length= 20, max_length = 20,start_with_G = False, internal_node_candidates = 10, PS_number = 12, PAMs = 0, off_targets = ''):
	...
	if alg == 'A' and use_thr > 0:
		...
		make_tree_display2.tree_display(path, alg == 'E', 'greedy_set_cover', off_targets, use_thr)
	...
	make_tree_display2.tree_display(path,alg == 'E', 'regular', off_targets, use_thr)
	make_tree_display2.tree_display(path,alg == 'E', 'removed_repetitions', off_targets, use_thr)
