...
#TreeConstruction = SourceFileLoader("module.name", "TreeConstruction_changed.py").load_module()
#from Bio.Phylo.TreeConstruction import _Matrix
#from TreeConstruction import DistanceTreeConstructor
from Bio import AlignIO
#from Bio.Phylo.TreeConstruction import DistanceCalculator
#shiransFunctions = SourceFileLoader("module.name", "/groups/itay_mayrose/shiranabad/CRISPR/code/utilities/scoring_functions.py").load_module()
import math

def cfd_func(sgseq, target_seq):
	#print(sgseq, target_seq)
	score = 1 - shiransFunctions.cfd_func(sgseq + "GGG", target_seq + "GGG")
	#print(score)
	return score
	#return 1 - shiransFunctions.cfd_func(sgseq + "GGG", target_seq + "GGG")
...
'''def make_distance_matrix(distance_function, names, seqs):
	 the input: distance_function that get 2 parameters every time
		list of names of the seqs,
		a list of sequs, adequate to the names list
		output: a distance matrix, in a format adequate to the UPGMA function'''


def shalem_score(seq1, seq2):
	'''frm CRISPR-MIT
	...
	#return 1 - original_score  ##is it right??
	#return distance, (last_mm - first_mm)/distance
	return 1 - original_score

#def shalem_score(seq1, seq2):
#    M = [0,0,0.14,0,0,0.395,0.317,0,0.398,0.079,0.445,0.508,0.613, 0.851, 0.723, 0.828, 0.615, 0.804, 0.685, 0.583]
#    Nmm, d_avg = find_Nmm_and_avg_d(seq1,seq2)


def shalem_score_new(seq1, seq2):
	"""
...
def test_s_score():
	...
	#print("closer:", cfd_func(a.upper(),b.upper()))
	#print("farther:", cfd_func(a.upper(),c.upper()))
...
if __name__ == "__main__":
	#test_s_score()
	#print(shalem_score_new('AATACACTGAATGATGCTGC', 'AACACACTGAATGATGCTGC'))
#	test_s_score()
	#print(1 -shalem_score("ACAAATGGCTGTAAATGGAC", "GCTAATGGCTGCAAATGGAC"))
	#print(1 -shalem_score("CAAAGCACTTTGTTGGTGAT", "CAAAGCACTTTGTTGGAGAT"))
	test_ccTop()