...
def sub_tree_display(path, results_url, candidates_lst, f, consider_homology, counter, genes_names, genes_lst, repetitions_flag):
#def sub_tree_display(path, results_url, candidates_lst, f, consider_homology, counter, genes_names, genes_lst):
	...
	if consider_homology == True:
		...
		f.write("<br><br>&#9658; "+repetitions_str+" <a id=\"abc\" href=\""+results_url+"\" style=\"font-size:16px; text-decoration: underline;\">click here</a>.</font><br><br><br>\n")
...
def tree_display(path, consider_homology = False, data = 'regular'):
	...
	if consider_homology == False:
		sub_tree_display(path, results_url, candidates_lst, f, consider_homology,counter, genes_names, genes_list, data == 'removed_repetitions')
		#sub_tree_display(path, results_url, candidates_lst, f, consider_homology,counter, genes_names, genes_list);
	else:
		#f.write("<i>The designed sgRNAs for the genes in your input are listed in the table below.<br>Every section of the table corresponds to a homologous genes subgroup as specified by the internal nodes of the constructed genes tree.<br>The name of the subgroup and the list of genes are given in the header of each section</i>.<br><br>\n")
		...
		#f.write("&nbsp&nbsp&nbsp&nbsp<a id=\"abc\" href=\"http://multicrispr.tau.ac.il/results.html?jobId=1517222057\" style=\"font-size:16px; text-decoration: underline;\"><b>Show only one sgRNA for each subset of possible targets</b></a><br><br>\n")
		#f.write("<input type=\"hidden\" id=\"scrl\" name=\"user\" value=\"0\" />\n")
		...
		for subgroup_item in candidates_lst:
			...
			f.write("</table>\n")
			sub_tree_display(path, results_url, subgroup_item.candidate_lst, f, consider_homology, counter, genes_names, genes_list, data == 'removed_repetitions')
